...
public class E_TargetHitChecker : MonoBehaviour
{
    ...
    public TextMeshProUGUI dialogueText;               // Ba�ar�l� oldu�unda ��kan metin
    public CanvasGroup dialogueCanvasGroup;

    public TextMeshProUGUI failText;                   // Ba�ar�s�z t�klama i�in k�sa metin
    public CanvasGroup failCanvasGroup;

    public E_FloatUpDown floatScript;  // Hareketi durduraca��m�z script
    ...
    public Vector3 targetPosition; // Genellikle sahnenin ortas�
    ...
    IEnumerator MoveAndScaleImage()
    {
        ...
        while (elapsed < moveDuration)
        {
            ...
            // Pozisyon ve �l�ek interpolasyonu
    ...
    void Start()
    {
        ...
        // Ba�lang��ta uyar� metni g�r�nmesin
